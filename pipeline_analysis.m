...
% Before you do an analysis, create directories for saving with the present date
...
%% Calculate and plot distances between assemblies
...
all_gcamp_props = process_poly2mask(truedataFolders, iscell_list, stat_list, all_outline_gcampx, all_outline_gcampy, validDirectories);
...
PathSave = 'D:/after_processing/Synchrony peaks/FCD';
[directories] = retrieve_results(PathSave);
[all_DF, all_ops, all_isort1, all_Raster, all_MAct, all_Race, dataFolders, all_data, animal_date_list, newStatPaths, newIscellPaths, newOpsPaths, validDirectories] = load_results(directories);
%%
...
plot_threshold_sce_evolution2(all_data, all_DF, all_MAct, animal_date_list, fractions, sce_n_cells_threshold, num_samples, field_width_microm, NShfl, synchronous_frames, MinPeakDistance, MinPeakDistancesce, directories)
%%
fit_linear_model(directories, all_data, animal_date_list)
%% SCEs analysis
