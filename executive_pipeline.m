...
if ~selected_groups_reloaded
    ...
    % PEAK DETECTION
    % ---------------------------------------------------------
    detection_mode = 'load_only';
    [selected_groups, recap_all] = ...
        DF_peak_detection( ...
            selected_groups, ...
            include_electroporated, ...
            automatic_selection, ...
...
% ============================================================
% Trier selected_groups selon recording_keep
% ============================================================

[selected_groups_filtered, recap_filtered] = ...
    filter_selected_groups_by_recording_keep( ...
        selected_groups, recap_all);
...
[selected_groups_filtered, results_table] = ...
    compute_DF( ...
        selected_groups_filtered, ...
        include_electroporated);
