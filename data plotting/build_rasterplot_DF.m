function build_rasterplot_DF( ...
    ...
    for m = 1:numFolders
        ...
        if isfield(data, 'motion') && ...
                ...
                isfield(data.motion, 'speed_active') && ...
                numel(data.motion.speed_active) >= m

            speed_active = ...
                data.motion.speed_active{m};
        end
        ...
        if isfield(data, 'motion') && ...
                isstruct(data.motion) && ...
                isfield(data.motion, 'motion_energy') && ...
                numel(data.motion.motion_energy) >= m

            motion_energy = ...
                data.motion.motion_energy{m};
        end
        ...
        for p = 1:nPlanes
            ...
            try
                ...
                if has_motion_energy
                    ...
                    axes_list = [axes_list ax3]; %#ok<AGROW>
                end
                    ...
                    elseif numel(valid_dates) < 2
                        ...
                        for idx = 1:nRows
                            ...
                            if isfield(metadata, 'DateName') && ...
                                    numel(metadata.DateName) >= mm

                                if iscell(metadata.DateName)

                                    current_date_value = ...
                                        metadata.DateName{mm};
