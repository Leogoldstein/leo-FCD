...
[daytime, directories, animal_date_list] = create_directories_for_analysis(truedataFolders, PathSave); % create directories for saving

save_paths(truedataFolders,directories, newFPaths, newStatPaths, newIscellPaths, newOpsPaths) % save paths in path.mat
%%
