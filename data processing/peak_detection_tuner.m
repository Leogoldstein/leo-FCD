function [F0, noise_est, valid_cells, DF_sg, DF_raw, Raster, ...
    ...
    if nargin < 38 || isempty(selection_summary_saved)
    ...
    % VIEWER EDITION
    %
    % false : fermeture sans sauvegarde
    % true  : bouton "Confirmer sélection" utilisé
    %==============================================================

    setappdata( ...
        fig, ...
        'viewer_selection_confirmed', ...
        false);
    ...
    if viewer_mode
        ...
        % Pas de nouveau cutoff automatique en Viewer.
        set( ...
    ...
    btn_roi_movie = ...
        uicontrol( ...
            ...
            'String', 'Start', ...
            'Units', 'normalized', ...
            'Position', [0.28 0.015 0.30 0.035], ...
            'FontWeight', 'bold', ...
            'FontSize', 10, ...
            'Tag', 'btn_roi_movie', ...
            'Callback', ...
...
function update_population_action_buttons(fig)
    ...
    % VIEWER :
    %
    % - pas de nouveau cutoff automatique ;
    % - ajout/retrait manuel autorisé ;
    % - confirmation uniquement depuis la population maître.
    % ==========================================================
    if viewer_mode
...
function finalize_and_close( ...
    ...
    % VIEWER
    %
    % En Viewer, fermer la fenêtre ne modifie rien.
    % Seul le bouton "Confirmer sélection" produit de nouvelles
    % sorties et permet à run_gcamp_peak_detection de les sauvegarder.
    %==============================================================

    if viewer_mode

        confirmed = ...
            isappdata(fig,'viewer_selection_confirmed') && ...
            getappdata(fig,'viewer_selection_confirmed');

        %==========================================================
        % Fermeture sans confirmation : aucune modification
        %==========================================================
        ...
        %==========================================================
        % Confirmation : conserver les résultats de détection
        % existants et modifier uniquement la sélection de cellules.
        %==========================================================
