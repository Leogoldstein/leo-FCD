        ...
        if ~isempty(axTrace) && ...
            ...
            if isempty(hCursor) || ...
                ...
                hHit = line( ...
                    ...
                    'HitTest', 'on', ...
                    'PickableParts', 'all', ...
                    'ButtonDownFcn', @(~,~) start_roi_cursor_drag(fig));
                
                setappdata(fig,'roi_movie_cursor_hitbox',hHit);
            ...
            if isappdata(fig,'roi_movie_cursor_hitbox')
                ...
                hHit = getappdata(fig,'roi_movie_cursor_hitbox');
            
                if ~isempty(hHit) && isgraphics(hHit)
            
                    hHit.XData = [t_movie t_movie];
                    hHit.YData = ylim(axTrace);
