function [F0, noise_est, valid_cells, DF_sg, DF_raw, Raster, ...
    ...
    if nargin < 35 || isempty(selection_summary_saved)
...
function finalize_and_close( ...
    ...
    % orig2new
    %
    % valid_cells = indices originaux dans le référentiel courant
    %==============================================================
