    ...
    for m = 1:numFolders
        ...
        if ~cache.metadata_match
            ...
            warning( ...
                ...
                ['GCaMP / electroporated metadata mismatch detected.\n' ...
                 'Recording group %d will continue through Cellpose loading/alignment.\n' ...
                 'Electroporated ROI extraction will be blocked only afterwards.\n%s'], ...
                m, ...
                cache.metadata_mismatch_message);
    ...
    for m = 1:numFolders
        ...
        if ~cache.metadata_match
            ...
            choice = input( ...
                ...
                'Press 1 to continue.\n' ...
                'Press any other key to skip this recording.\n> '], ...
                cache.metadata_mismatch_message), ...
                's');
            ...
            if user_accepted_metadata_mismatch
                ...
                fprintf( ...
                    ['Group %d plane %d: Cellpose outputs stored. ' ...
                     'Metadata mismatch accepted for alignment only; ' ...
                     'electroporated ROI extraction skipped.\n'], ...
                    m, ...
                    p);
