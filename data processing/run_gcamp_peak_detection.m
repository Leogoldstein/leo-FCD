function data = run_gcamp_peak_detection( ...
    ...
    for m = 1:numFolders
        ...
        for p = 1:nPlanes
            ...
            % ==================================================
            % Decide branch for THIS plane
            %
            % Global include_electroporated = 1 does NOT imply
            % that every plane necessarily contains COMBINED.
            %
            % If F_combined is absent:
            %     fallback -> F_gcamp
            % ==================================================
            ...
            % ==================================================
            % Common Suite2p data from GCaMP
            % ==================================================
            stat_in = ...
                get_branch_plane_or_empty( ...
                    data, ...
            ...
            if isempty(F_in)
                ...
                fprintf( ...
                    '%s - plane %d: F_gcamp unavailable, plane skipped.\n', ...
                    record_label_m, ...
                    p);
            ...
            % ==================================================
            % Detection branch for THIS plane
            % ==================================================
            if use_combined_this_plane
            ...
            if viewer_mode || ...
                ...
                %
                % No tuner.
                % Preview generated from saved detection.
                % ==================================================
                if load_only_plane
            ...
            if viewer_mode
                ...
                % --------------------------------------------------
                % Saved detection contains only validated cells.
                %
                % F must therefore be reduced to exactly the same
                % original indices.
                % --------------------------------------------------
                ...
                if isempty(viewer_original_indices) || ...
                    ...
                    warning( ...
                        ['%s - plane %d: valid_cells sauvegardé ' ...
                         'incompatible avec DF sauvegardé. ' ...
                         'Recalcul normal.'], ...
                        record_label_m, ...
                        p);
                    ...
                    % ----------------------------------------------
                    % Remap electroporated indices to viewer-local
                    % indices.
                    % ----------------------------------------------
                    if use_combined_this_plane && ...
            ...
            % Random peak preview
            %
            % Called in every mode reaching peak_detection_tuner:
            %   - new/global detection
            %   - viewer
            %
            % load_only is handled separately because it does not
            % call peak_detection_tuner.
            % ==================================================
            ...
            % ==================================================
            % Viewer: never create/update anything
            % ==================================================
            if viewer_mode
                continue;
            end
            ...
            if use_combined_this_plane
                ...
                % ==================================================
                % Reconstruct GCaMP + electroporated from COMBINED
                % ==================================================
                [ ...
                    data, ...
                    has_new_gcamp_plane, ...
