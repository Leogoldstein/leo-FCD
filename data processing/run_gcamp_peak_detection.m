...
function data = clear_detection_outputs_for_plane_in_data( ...
    ...
    % ==========================================================
    % Effacement pour UN plan donné :
    %
    % 1. Dans data
    % 2. Dans les fichiers results_*.mat
    %
    ...
    for b = 1:numel(branches_to_clear)
        ...
        % ======================================================
        % 2. EFFACER LE PLAN DANS LE FICHIER results_*.mat
        % ======================================================
        if isempty(filePath) || ...
        ...
        for f = 1:numel(fields)
            ...
            % --------------------------------------------------
            % Les fichiers results contiennent normalement :
            %
            % field = cell(nPlanes,1)
            %
            % On ne supprime donc PAS toute la variable.
            % On efface uniquement le plan p.
            % --------------------------------------------------
            if iscell(value) && ...
                    numel(value) >= p
            ...
            elseif p == 1
                ...
                % ------------------------------------------------
                % Sécurité ancien format :
                % si ce n'est pas une cell de plans et qu'il n'y
                % a qu'un seul plan, on peut vider la variable.
                % ------------------------------------------------
                S.(fn) = [];
        ...
        if changed
            ...
            fprintf( ...
                'Plane %d detection cleared from %s\n', ...
                p, ...
                filePath);
        end
    end
