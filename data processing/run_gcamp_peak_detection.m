function data = run_gcamp_peak_detection( ...
    ...
    for m = 1:numFolders
        ...
        %
        % motion_energy_group and speed_active_group are expressed
        % in global-frame coordinates.
        %
        % Therefore:
        %     NO division by nPlanes.
        % ======================================================
        [ ...
            motion_energy_group, ...
            speed_active_group, ...
        ...
        % ======================================================
        % Return cropped motion signals to data
        % ======================================================
        ...
        for p = 1:nPlanes
            ...
            if viewer_mode || ...
                ...
                % LOAD ONLY
                %
                % Motion was already cropped before plane loop.
                % ==================================================
                if load_only_plane
            ...
            if ~viewer_mode
                ...
                % ==================================================
                % Already cropped at global-frame level.
                %
                % DO NOT crop motion_energy to nT.
                % DO NOT crop speed_active to nT.
                % ==================================================
                motion_energy = ...
                    motion_energy_group;
