function [data, has_new_saved, modified_planes] = run_gcamp_peak_detection( ...
    ...
    % Defaults
    % ==========================================================
    if nargin < 15 || isempty(include_electroporated)
        include_electroporated = '1';
    end
    
    if nargin < 16 || isempty(peak_detection_mode)
    ...
    for m = 1:numFolders
       ...
       gcamp_suite2p_folders_m = ...
        ...
        for p = 1:nPlanes
            ...
            % COMMENTAIRE MODIFIÉ
            %
            % Le commentaire est sauvegardé indépendamment de la
            % sélection.
            %
            % IMPORTANT :
            %   - ne met PAS has_new à true
            %   - ne met PAS has_new_saved à true
            %   - ne modifie PAS modified_planes
            %   - ne recrée PAS les figures
            % ==================================================
            ...
            if comment_modified
                ...
                % Ne pas conserver ce flag technique dans le summary.
                selection_summary = ...
                    rmfield( ...
                        selection_summary, ...
                        'comment_modified');
                ...
                if use_combined_this_plane
                    ...
                    % ------------------------------------------
                    % Reporter également le commentaire dans les
                    % summaries GCaMP / Electroporated existants.
                    % ------------------------------------------
                    comment_value = '';

                    if isfield(selection_summary,'comment')
                        comment_value = ...
            ...
            % ==================================================
            % RECRÉER LES FIGURES DU PLAN MODIFIÉ
            %
            % À ce stade :
            %   modified_planes{m}(p) == true
            % uniquement si le plan a réellement été sauvegardé.
            %
            % Fonctionne également en mode Viewer.
            % ==================================================
            
            if modified_planes{m}(p)
