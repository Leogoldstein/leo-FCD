function SCEs_groups_analysis2(selected_groups, all_DF_groups, all_Race_groups, all_TRace_groups, sampling_rate, all_Raster_groups, all_sces_distances_groups)
    ...
    data_by_age = struct('NCells', nan(numel(age_labels), num_animals), ...
                         ...
                         'Ratio', nan(numel(age_labels), num_animals));
    ...
    measures = {'NCells', 'NumSCEs', 'SCEFreq', 'AvgActiveSCE', 'SCEDuration', 'Ratio'};
    measure_titles = {'NCells', 'Number of SCEs', 'SCE Frequency', 'Avg Active Cells in SCEs', ...
                      'SCE Duration (ms)', 'Ratio of Active Cells in/Out SCEs'};
    ...
    for measureIdx = 1:num_measures
        ...
        b = bar(x_valid, means, 'FaceColor', 'flat');
