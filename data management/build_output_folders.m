...
%       true);
    ...
    include_electroporated = parse_logical_scalar_DF( ...
        include_electroporated, ...
        false);
...
% et au type de cellules incluses.
    ...
    if automatic_selection && include_electroporated

        summary_subfolder = ...
            'Pre-selection electroporated cells';

    elseif automatic_selection && ~include_electroporated
