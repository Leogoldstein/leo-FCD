...
function selected_paths = ...
    ...
    while ~isempty(remaining_paths)
        ...
        % ------------------------------------------------------
        % Cas spécial :
        % il ne reste qu'un seul TSeries
        % ------------------------------------------------------
        ...
        if numel(remaining_paths) == 1
            ...
            choice = ...
                questdlg( ...
                    sprintf( ...
                        ...
                        'Voulez-vous également l''ajouter ?']), ...
            ...
            if strcmp(choice, 'Oui')
                ...
                % Ajouter directement le dernier TSeries
                selected_paths{end+1,1} = ...
                    remaining_paths{1};

                fprintf( ...
                    'TSeries GCaMP ajouté automatiquement :\n%s\n', ...
                    remaining_paths{1});
        ...
        % ------------------------------------------------------
        % Plus d'un TSeries reste disponible
        % ------------------------------------------------------
