    ...
    for t = 1:numel(type_names)
        ...
        for k = 1:numel(selected_groups.(current_type))
            ...
            for idx = 1:nRecordings
                ...
                gcamp_tseries_name = ...
                    get_tseries_name( ...
                        current_TSeries_group{idx,1});
                
                electroporated_tseries_name = '';
...
function tseries_name = get_tseries_name(tseries_path)

    tseries_name = '';

    if isempty(tseries_path)
        return;
    end

    % Retirer les séparateurs finaux éventuels
    while ~isempty(tseries_path) && ...
            ( ...
                tseries_path(end) == '\' || ...
                tseries_path(end) == '/' ...
            )
